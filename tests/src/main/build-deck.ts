...
// Import types
import { Card, CardType, Element as ElementEnum } from '../../../src/types/Card.ts';
import { Deck } from '../../../src/types/Deck.ts';

// Import modular functions
import { parseCommandLineArgs, BuildOptions } from '../../../src/main/commandLineParser.ts';
import { processCardData } from '../../../src/main/cardProcessor.ts';
import { selectAvatar } from '../../../src/main/avatarSelector.ts';
import { validateDeck } from './deckValidation';
import { generateDeckReport, DeckStatsData } from '../../../src/main/deckReporting.ts';
import { exportDeck, logCardDistribution } from './deckExportManager';

// Import remaining modules
const utils = require('../../../src/utils/utils');
const deckStats = require('../../../src/analyses/synergy/deckStats');
const siteSelector = require('../../../src/analyses/position/siteSelector');
const deckBuilder = require('../../../src/core/deck/builder/deckBuilder');
const synergyCalculator = require('../../../src/analyses/synergy/synergyCalculator');
